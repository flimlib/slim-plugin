...
public class CursorEstimatorTest {
	...
	public void testEstimateDecayCursors() {
		...
		final double xInc = 0.0;
		final double[] decay = null;
		final int[] expResult = null;
		final int[] result = CursorEstimator.estimateDecayCursors(xInc, decay);
	...
	/**
	 * Test of estimateCursors method, of class CursorEstimator. Since the method
	 * under test uses curve fitting this test may break if the fitting process is
	 * tweaked.
	 */
	// @Test
	public void testEstimateCursors() {
		...
		final double[] decay =
			{ 1.0, 2.0, 1.0, 3.0, 2.0, 2.0, 0.0, 0.0, 0.0, 1.0, 4.0, 2.0, 1.0, 1.0,
				...
				1.0, 2.0, 2.0, 2.0, 2.0, 0.0, 4.0, 0.0, 2.0, 2.0, 1.0, 1.0, 1.0, 2.0,
				0.0, 2.0 };
		final double chiSqTarget = 1.5;
		final double[] expResult =
			{ 27.0, 90.0, 2.477064220183486, 27.0, 37.0, 230.0 };
		final double[] result =
